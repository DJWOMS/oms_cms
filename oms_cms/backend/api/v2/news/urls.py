...
urlpatterns = [
    ...
    path('tags-delete-update/<slug:slug>/', views.TagsDeleteUpdateWithSlug.as_view()),    # Удалить/изменить тег (slug)
    path('tags-create/', views.TagsCreate.as_view()),                                      # Создание тега
    ...
    path('category-delete-update/<int:id>/', views.CategoryDeleteUpdateWithId.as_view()),     # Удалить/изменить категорию (ID)
    path('category-delete-update/<slug:slug>/', views.CategoryDeleteUpdateWithSlug.as_view()), # Удалить/изменить категорию (slug)
    path('category-create/', views.CategoryCreate.as_view()),                                         # Создание категории
    ...
    path('post-delete-update/<int:id>/', views.PostDeleteUpdateWithId.as_view()),     # Удалить/изменить новость (ID)
    path('post-delete-update/<slug:slug>/', views.PostDeleteUpdateWithSlug.as_view()),     # Удалить/изменить новость (slug)
    path('post-create/', views.PostCreate.as_view()),                                         # Создание новости
]
